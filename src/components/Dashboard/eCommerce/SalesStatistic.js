...
import {lineChartData, radialData} from "./data";
            ...
            <div className="row mb-3">
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                    <span className="d-flex align-items-center mb-2">
                        ...
                        <span className="ml-3 text-dark">548</span>
                    </span>
                ...
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                    <span className="d-flex align-items-center mb-2">
                        ...
                        <span className="ml-3 text-dark">75</span>
                    </span>
                ...
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                    <span className="d-flex align-items-center mb-2">
                        ...
                        <span className="ml-3 text-dark">$7713</span>
                    </span>
                ...
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                    <span className="d-flex align-items-center mb-2">
                        <i className="zmdi zmdi-money-box text-muted chart-f20"/>
                        <span className="ml-3 text-dark">$96874</span>
                    </span>
                ...
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                    <span className="d-flex align-items-center mb-2">
                        ...
                        <span className="ml-3 text-dark">543</span>
                    </span>
